...
//SDL window and renderer initialization for the server
...
//SDL window and renderer initialization for the client
...
//The function that draws the universe renders the planets first, then the trash and finally the ships. This way, the render "layers" go planet>trash>ship
